<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Defaults_Tutors.aspx.cs" Inherits="NIT.Defaults_Tutors" %>
    ...
    <div class=" col-sm-2 col-md-3 col-lg-3"></div>
        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
            ...
            <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        <label>Tutor Code</label>
                         <div class="input-group mb-10"> <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                            <asp:TextBox CssClass="form-control" runat="server" ID="TutorCode" Placeholder="Your Tutor Code" required="True"/>
                        </div>
                    </div>
                    <hr/>
                    <div class="form-group">
                ...
                <div class="panel-footer" style="background-color:#A9A9A9;">
                <label>First Login/Forgot Password? <a href="GetNewTutorPassword.aspx" runat="server" style="color: white;">Reset Password</a></label>&nbsp;
                </div>
            </div>
