...
// and right space that was offset by the scrollbars. A 1-yatri border first, then margin beyond that.
...
/* A "coordinate map" converts yatri coordinates into an associated cell, which has an associated date
------------------------------------------------------------------------------------------------------------------------
Common interface:
...
var DragListener = fc.DragListener = Class.extend({
	...
	scrollTopVel: null, // yatris per second
	scrollLeftVel: null, // yatris per second
	scrollIntervalId: null, // ID of setTimeout for scrolling animation loop
	scrollHandlerProxy: null, // this-scoped function for handling when scrollEl is scrolled

	scrollSensitivity: 30, // yatris from edge for scrolling to start
	scrollSpeed: 200, // yatris per second, at maximum speed
...
var MouseFollower = Class.extend({
	...
	// the number of yatris the mouse has moved from its initial position
	topDelta: null,
	leftDelta: null,
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	coordMap: null, // a GridCoordMap that converts yatri values to datetimes
...
Grid.mixin({
	...
	listenToExternalDrag: function(el, ev, ui) {
		...
		// listener that tracks mouse movement over date-associated yatri regions
...
var View = fc.View = Class.extend({
	...
	coordMap: null, // a CoordMap object for converting yatri regions to dates
	...
	// Given the total height of the view, return the number of yatris that should be used for the scroller.
